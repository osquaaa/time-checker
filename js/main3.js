...
function getNextBirthday() {
	...
	let birthday = new Date(`${currentDate.getFullYear()}-01-06T22:51:20`)

	// Если день рождения уже прошёл в этом году, устанавливаем на следующий год
	if (currentDate > birthday) {
		birthday = new Date(`${currentDate.getFullYear() + 1}-01-06T22:51:20`)
	}
...
function updateCounter() {
	...
	if (diff <= -3600000) {
		...
		title.innerText = 'до Дня Рождения Трофима осталось:'
...
function showBirthdayGreeting() {
	...
	title.innerText = '🎉 С Днём Рождения, Трофим! 🎂🎁'
